...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LogWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 62, 14)
    ...
    "LogWidget\0infoReceived\0\0system\0message\0"
    "on_clearButton_clicked\0onInfoReceived"
};
...
void LogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->infoReceived((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->on_clearButton_clicked(); break;
        case 2: _t->onInfoReceived((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (LogWidget::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogWidget::infoReceived)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject LogWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_LogWidget.data,
      qt_meta_data_LogWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LogWidget.stringdata))
...
// SIGNAL 0
void LogWidget::infoReceived(const QString & _t1, const QString & _t2)
{
