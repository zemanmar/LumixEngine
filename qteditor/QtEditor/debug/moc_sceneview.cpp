...
struct qt_meta_stringdata_SceneView_t {
    QByteArrayData data[1];
    char stringdata[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SceneView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SceneView_t qt_meta_stringdata_SceneView = {
    {
...
const QMetaObject SceneView::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_SceneView.data,
      qt_meta_data_SceneView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SceneView.stringdata))
