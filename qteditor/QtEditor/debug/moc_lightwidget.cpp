...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LightWidget_t, stringdata) + ofs \
...
const QMetaObject LightWidget::staticMetaObject = {
    { &PropertyWidgetBase::staticMetaObject, qt_meta_stringdata_LightWidget.data,
      qt_meta_data_LightWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LightWidget.stringdata))
